# Status
- 14:00 ORCH: master plan, repo, role tasks created. Next: CORE scaffold.
- 14:21 ORCH: pipeline design in docs/PIPELINE.md (video → labels → live).
- 14:28 ORCH: pipeline v2 (Swift + ARKit + Gemini Live), roles IOS-REC / IOS-GO / LIVE / VIDEO updated.
